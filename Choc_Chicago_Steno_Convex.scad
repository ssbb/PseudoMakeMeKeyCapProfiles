...
//  BotWid, BotLen, TWDif, TLDif, keyh, WSft, LSft  XSkew, YSkew, ZSkew, WEx, LEx, CapR0i, CapR0f, CapR1i, CapR1f, CapREx, StemEx
    ...
    [17.5,  16.5,   5.6, 	   5,  3.8,    0,  -.5,     7,    -0,    -0,   2, 2,    .10,      3,     .10,      3,     2,       4], //Chicago Steno R2x 1u
    [17.5,  16.5,   5.6, 	   5,  4.4,    0,   .0,     0,    -0,    -0,   2, 2,    .10,      3,     .10,      3,     2,       4], //Chicago Steno R3x 1u

    // R3x 1.25~2.25u [4:8]
    [22.0,   16.5,   5.6, 	   5.6,  4.5,   0,   .0,   0,    -0,    -0,   2, 2.5,   .1,      3,     .1,      3,     2,       4], //Chicago Steno R3x 1.25u
    [26.5,  16.5,   5.6, 	   5.6,  4.5,   0,   .0,   0,    -0,    -0,   2, 2.5,   .1,      3,     .1,      3,     2,       4], //Chicago Steno R3x 1.5u
    [31.0,  16.5,   5.6, 	   5.6,  4.5,   0,   .0,   0,    -0,    -0,   2, 2.5,   .1,      3,     .1,      3,     2,       4], //Chicago Steno R3x 1.75u
    [35.5,  16.5,   5.6, 	   5.6,  4.5,   0,   .0,   0,    -0,    -0,   2, 2.5,   .1,      3,     .1,      3,     2,       4], //Chicago Steno R3x 2.0u
    [40.0,  16.5,   5.6, 	   5.6,  4.5,   0,   .0,   0,    -0,    -0,   2, 2.5,   .1,      3,     .1,      3,     2,       4], //Chicago Steno R3x 2.25u
