...
//  BotWid, BotLen, TWDif, TLDif, keyh, WSft, LSft  XSkew, YSkew, ZSkew, WEx, LEx, CapR0i, CapR0f, CapR1i, CapR1f, CapREx, StemEx
    ...
    [17.5,  16.5,   5.6, 	   5,  5.0,    0,   .0,     5,    -0,    -0,   2, 2.5,    .10,      2,     .10,      3,     2,       4], //Levee Steno R2/R4
    [17.5,  16.5,   5.6, 	   5,  4.6,    0,   .0,     0,    -0,    -0,   2, 2.5,    .10,      3,     .10,      3,     2,       4], //Levee Steno R3
    //Thumb
    [17.5,  16.5,  4.25, 	3.25,  5.0,  -.5,  0.0,    -3,    -3,    -0,   2,   2,    .10,      2,     .10,      2,     2,       4], //Thumb 1
    [16.5,  26.5,   5.5, 	3.25,  4.9,  -.5,  0.0,    -3,    -2,    -2,   2,   2,     .3,      2,      .3,    2.5,     2,       4], //Thumb 1.5
    [15.5,  35.5,  4.25, 	3.25,  4.9, -.25,  0.0,    -2.5,    -4,    -2,   2,   3,     .3,      2,      .3,    2.5,     2,       4], //Thumb 2.0
    //1.25 5
    [22.0,   16.5,  5.6, 	   5,  4.5,    0,   .0,     5,    -0,    -0,   2,   2,     .5,      3,      .5,      3,     2,       4], //Chicago Steno R2/R4 1.25u
    [22.0,   16.5,  5.6, 	   5,  4.5,    0,   .0,     0,    -0,    -0,   2,   2,     .5,      3,      .5,      3,     2,       4], //Chicago Steno R3 1.25u
    //1.5 7
    [26.5,  16.5,   5.6, 	   5,  4.5,    0,   .0,     5,    -0,    -0,   2,   2,     .5,      3,      .5,      3,     2,       4], //Chicago Steno R2/R4 1.5
    [26.5,  16.5,   5.6, 	   5,  4.5,    0,   .0,     0,    -0,    -0,   2,   2,     .5,      3,      .5,      3,     2,       4], //Chicago Steno R3 1.5u
    //1.75 9
    [31.0,  16.5,   5.6, 	   5,  4.5,    0,   .0,     5,    -0,    -0,   2,   2,     .5,      3,      .5,      3,     2,       4], //Chicago Steno R2/R4 1.5
    [31.0,  16.5,   5.6, 	   5,  4.5,    0,   .0,     0,    -0,    -0,   2,   2,     .5,      3,      .5,      3,     2,       4], //Chicago Steno R3 1.5u
    // Ergo shits
    [18.5,  18.5,   5.6, 	   5,    8,    0,   .25,     0,    -0,    -0,   2, 2.5,    .10,      3,     .10,      3,     2,       4], //highpro 19.05 R2|4
...
//FFwd1 FFwd2 FPit1 FPit2  DshDep DshHDif FArcIn FArcFn FArcEx     BFwd1 BFwd2 BPit1 BPit2  BArcIn BArcFn BArcEx FTani FTanf BTani BTanf TanEX PhiInit PhiFin
  ...
  //1.25
  [ 4.5,    4,    7,  -40,      8,    1.8,   15,    20,     2,      4.7,    4,    2,   -35,   15,    20,     2,     3,    5,    7,    5,   2, 200, 210], //Chicago Steno R2/R4
  [ 4.5,    4,    5,  -40,      8,    1.8,   15,    20,     2,      4.7,    4,    5,   -40,   15,    20,     2,     3,    5,    7,    5,   2, 200, 210], //Chicago Steno R3
  //1.5
  [ 4.5,    4,    7,  -40,      8,    1.8,   19,    25,     2,      4.7,    4,    2,   -35,   19,    25,     2], //Chicago Steno R2/R4
  [ 4.5,    4,    5,  -40,      8,    1.8,   19,    25,     2,      4.7,    4,    5,   -40,   19,    25,     2], //Chicago Steno R3
  //1.75
  [ 4.5,    4,    7,  -40,      8,    1.8,   22.5,  27,     2,      4.7,    4,    2,   -35,   22.5,  27,     2], //Chicago Steno R2/R4
  [ 4.5,    4,    5,  -40,      8,    1.8,   22.5,  27,     2,      4.7,    4,    5,   -40,   22.5,  27,     2], //Chicago Steno R3
